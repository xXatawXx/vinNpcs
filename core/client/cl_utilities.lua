...
Utils = {
    ...
    DrawText3Ds = function(coords, text, scale, color, notRect) -- Better Draw GD IN 3D Text function
    ...
    AddBlip = function(coords, sprite, colour, label) -- Create Blip function
